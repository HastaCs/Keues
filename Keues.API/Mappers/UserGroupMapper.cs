...
public static class UserGroupMapper
{
  ...
  {
    return new UpdateUserGroupCommand(id, request.Name, request.Color, request.LocationId);
  }
  public static CreateUserGroupCommand ToCommand(this CreateUserGroupRequest request)
  {
    return new CreateUserGroupCommand(request.Name, request.Color, request.LocationId);
  }
